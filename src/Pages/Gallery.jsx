...
import { supabase } from "../supabase"; // Pastikan sudah buat supabase.js
...
const Carousel = () => {
  ...
  // === Ambil gambar dari bucket "foto-murid" di folder "uploads" ===
  const fetchImagesFromSupabase = async () => {
    try {
      const { data, error } = await supabase.storage
        .from("foto-murid") // Bucket
      ...
      // Generate URL publik untuk setiap gambar
      const urls = data.map(
        (file) =>
